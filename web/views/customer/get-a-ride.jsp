<body>
    ...
    <script>
        ...
        function myMap() {
            ...
            google.maps.event.addListener(map, 'click', function(event) {
              ...
              calcRoute(event.latLng, directionsRenderer, directionsService, map);
        ...
        function calcRoute(location, directionsRenderer, directionsService, map) {
            directionsRenderer.setMap(map);
            var start = new google.maps.LatLng(startPoint[0].getPosition().lat(), startPoint[0].getPosition().lng());
    ...
    <div>
        <form action="<%=request.getContextPath()%>/get-a-ride" method="post" name="bookaride">
            <input type="submit" value="book ride" id="book" onclick="myFunction()" disabled="true" />
